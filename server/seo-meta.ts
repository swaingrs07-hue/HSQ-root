...
const COLLEGE_FAQ_MAP: Record<string, { q: string; a: string }[]> = {
  ...
  "/hostel-near-dj-sanghvi": [
    { q: "How far is Hsquare from DJ Sanghvi?", a: "Our Goregaon property is conveniently located for DJ Sanghvi College students with easy commute access." },
...
const COLLEGE_HOSTEL_LD: Record<string, object> = {
  ...
  "/hostel-near-dj-sanghvi": {
    ...
    "description": "Best hostel near DJ Sanghvi College of Engineering Mumbai. Furnished rooms with meals, WiFi, gym & security.",
  ...
  "/hostel-in-vile-parle": {
    ...
    "description": "Best student hostel in Vile Parle Mumbai near Mithibai, NM College & Whistling Woods. Fully furnished rooms, meals, WiFi & 24/7 security.",
  ...
  "/hostel-in-goregaon": {
    ...
    "description": "Top hostel in Goregaon East Mumbai near NMIMS & Mukesh Patel. Premium PG accommodation with meals, WiFi, gym & security.",

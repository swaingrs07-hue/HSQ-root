...
export const chatbotSettings = pgTable("chatbot_settings", {
  ...
  botName: text("bot_name").default("H Orbit").notNull(),
  greetingMessage: text("greeting_message").default("Hello! I'm H Orbit, your personal assistant for finding the perfect student accommodation. How can I help you today?").notNull(),

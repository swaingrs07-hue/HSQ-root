  ...
  return (
    <div data-testid="hotels-home-page">
      ...
      >
        ...
        <div className="relative z-20 container mx-auto px-6 pt-24 pb-16 text-center">
          <div className="hotels-fade-in">
            ...
            <h1 className="hotels-display text-white text-5xl sm:text-6xl md:text-8xl lg:text-9xl mb-8" data-testid="text-hotel-headline">
              A New Chapter
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/hotels/rooms"
                className="px-10 py-4 text-black uppercase text-xs tracking-[0.3em] font-semibold transition-all duration-300 hover:scale-[1.05] inline-flex items-center gap-3"
              ...
              <a
                href="#experience"
                className="px-10 py-4 uppercase text-xs tracking-[0.3em] text-white border border-white/30 hover:bg-white/5 transition-colors"
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative">
              ...
              <div
                className="absolute -bottom-8 -right-8 px-8 py-6 hidden md:block"
            ...
            <div>
              ...
              <h2 className="hotels-display text-white text-5xl md:text-7xl mb-8">
      ...
      <section className="py-24 md:py-32 px-6" style={{ backgroundColor: "var(--hotels-section-bg, #080808)" }} data-testid="section-rooms">
        <div className="container mx-auto">
          <div className="text-center mb-16 md:mb-24">
            ...
            <h2 className="hotels-display text-white text-5xl md:text-7xl">
              Sanctuary, <span style={{ fontStyle: "italic", color: "#c5a059", fontWeight: 300 }}>elevated</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8 md:gap-6 items-end">
      ...
      <section id="dining" className="py-24 md:py-32 px-6" data-testid="section-dining">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-5 gap-16 items-center">
            ...
            <div className="lg:col-span-3 lg:order-1">
              ...
              <div className="flex gap-6 text-sm">
                <div>
                  <div className="text-3xl font-bold text-white mb-1">7AM</div>
                  <div className="text-[10px] uppercase tracking-widest text-white/40">Breakfast Opens</div>
                </div>
                <div className="border-l border-white/10 pl-6">
                  <div className="text-3xl font-bold text-white mb-1">11PM</div>
      ...
      <section className="relative py-32 px-6 overflow-hidden" style={{ backgroundColor: "var(--hotels-section-bg, #080808)" }} data-testid="section-cta">
        ...
        <div className="relative z-10 container mx-auto text-center">
          <p className="text-[11px] uppercase tracking-[0.4em] mb-8" style={{ color: "#c5a059" }}>
            ◇ Begin Your Stay ◇
          </p>
          <h2 className="hotels-display text-white text-5xl md:text-8xl mb-10">
            Reserve in
            <br />
          ...
          <Link
            href="/hotels/rooms"
            className="inline-flex items-center gap-3 px-12 py-5 text-black uppercase text-xs tracking-[0.3em] font-semibold transition-all duration-300 hover:scale-[1.05]"

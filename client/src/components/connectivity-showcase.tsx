...
const HOTSPOTS: Array<{ name: string; lat: number; lng: number; type: string }> = [
  ...
  { name: "Jai Hind College", lat: 18.9366, lng: 72.8282, type: "university" },
  { name: "St. Xavier's College", lat: 18.9398, lng: 72.8315, type: "university" },
  { name: "KC College", lat: 18.9372, lng: 72.8278, type: "university" },
  { name: "Mumbai University", lat: 19.0225, lng: 72.8558, type: "university" },
  { name: "SIES College", lat: 19.0415, lng: 72.8620, type: "university" },
  { name: "Thakur College", lat: 19.2072, lng: 72.8718, type: "university" },
  { name: "Rizvi College", lat: 19.0625, lng: 72.8404, type: "university" },
  { name: "Sophia College", lat: 18.9718, lng: 72.8090, type: "university" },
  { name: "TISS", lat: 19.0437, lng: 72.8605, type: "university" },
  { name: "ICT Mumbai", lat: 19.0226, lng: 72.8558, type: "university" },
  { name: "VJTI", lat: 19.0228, lng: 72.8555, type: "university" },

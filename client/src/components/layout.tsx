                  ...
                  {footer.androidDownloadUrl && (
                    ...
                    >
                      <svg className="w-6 h-6 text-emerald-400 group-hover:text-emerald-300 transition-colors" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M3.18 23.76c.3.17.64.23.99.17l13.2-7.62-2.82-2.82-11.37 10.27zM.44 1.07C.16 1.4 0 1.89 0 2.53v18.94c0 .64.16 1.13.44 1.46l.07.07 10.61-10.61v-.25L.51 1.0l-.07.07zM20.69 10.28l-2.89-1.67-3.17 3.17 3.17 3.17 2.92-1.68c.83-.48.83-1.26-.03-1.99zM4.17.24L17.37 7.86l-2.82 2.82L3.18.41C3.48-.04 3.87-.12 4.17.24z"/>
                      </svg>
                      <div>
                        <p className="text-[10px] text-stone-500 leading-none">Get it on</p>
                        <p className="text-sm font-semibold text-stone-200 group-hover:text-white transition-colors leading-tight">Google Play</p>
                      </div>
                    </a>
                  )}
                </div>
